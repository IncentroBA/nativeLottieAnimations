...
export function NativeLottieAnimations({
    fileVisibility,
    lottieFile,
    style,
    useAsLoader,
    ...
    if (lottieFile) {
        return (
            <View style={visible ? containerStyle : styles.hidden}>
                <LottieView style={setImageStye} source={JSON.parse(lottieFile)} autoPlay loop />
            </View>
        );
    } else return null;
}
